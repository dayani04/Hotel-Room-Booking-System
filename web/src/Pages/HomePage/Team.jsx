...
export default function Teams() {
  ...
  const team = [
    ...
    {
      image: "../assets/img/owner4.jpg",
      name: "Masi Jehnsan (Housekeeper)",
      designation: "Ensures that rooms are clean, well-maintained, organized, and ready for guests.",
    },
    {
      image: "../assets/img/owner3.jpg",
      name: "Sarahna Kaihisa Lee (Chef)",
      designation: "Prepares meals for guests, manages kitchen staff, and ensures food quality and cleanliness in the kitchen.",
    },
  ];
